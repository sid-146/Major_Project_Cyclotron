...
# model.load_state_dict(
    # torch.load("saved_modelcyclone", map_location=torch.device("cpu"))
# )
# model.eval()
...
def predict():
    ...
    if imagefile and allowed_img(imagefile.filename):
        ...
        return render_template(
            "index.html", prediction=predicted_intensity, filename=filename, rain=r, x=1
        )
    else:
